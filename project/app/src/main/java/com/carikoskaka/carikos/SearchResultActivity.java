...
public class SearchResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        keywordText = intent.getStringExtra("KEYWORD_VALUE");
        Log.d("anto", "s24");
        ...
        lvItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SearchResultActivity.this, DetailHouseActivity.class);
    ...
    private class GetHouses extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if( houseList != null ) {
                if (adapter == null) {
                    adapter = new HouseAdapter(SearchResultActivity.this, houseList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add_task:
                Intent intent = new Intent(SearchResultActivity.this, SearchDataActivity.class);
